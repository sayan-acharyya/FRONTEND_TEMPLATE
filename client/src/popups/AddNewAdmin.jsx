      ...
      <div className="w-full bg-white rounded-lg shadow-lg md:w-1/3">
        <div className="p-6">
          ...
          <form onSubmit={handleAddNewAdmin}>
            ...
            <div className="mb-4">
              <label className="text-gray-900 block font-medium">Name</label>
              <input
                type="text"
                value={name}
            ...
            <div className="mb-4">
              <label className="text-gray-900 block font-medium">Email</label>
              <input
                type="email"
                value={email}
            ...
            <div className="mb-4">
              <label className="text-gray-900 block font-medium">Password</label>
              <input
                type="password"
                value={password}
