  ...
  return <>
    <div className="flex flex-col justify-center md:flex-row h-screen">
      ...
      p-8 rounded-tr-[80px] rounded-br-[80px]">
        <div className="text-center h[450px]">
          <div className="flex justify-center mb-12">
            <img src={logo_with_title} alt="logo" className="m-12 h-44 w-auto" />
          </div>
      ...
      <div className="w-full md:w-1/2 flex items-center justify-center bg-white p-8 relative">
        <Link to="/password/forgot" className="border-2 border-black rounded-3xl font-bold py-2 w-52 text-start px-4 fixed
              top-10 -right-28 hover:bg-black hover:text-white transition duration-300">
          Back
        </Link>
